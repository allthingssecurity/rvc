...
def process_audio():
    ...
    try:
        ...
        subprocess.run(['python3', 'train_nsf_sim_cache_sid_load_pretrain.py', '-e', 'sample1', '-sr', '40k', '-f0', '1', '-bs', '19', '-g', '0', '-te', '10', '-se', '10', '-pg', 'pretrained/f0G40k.pth', '-pd', 'pretrained/f0D40k.pth', '-l', '0', '-c', '0'], check=True)
